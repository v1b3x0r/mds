<p align="center">
  <img src="docs/social-card.svg" alt="MDS — Material Definition System: eight strata of a living world" width="100%"/>
</p>
...
**New here?** Read the **[Field Guide — Anatomy of a Living World](docs/FIELD-GUIDE.md)**: what each of the 8 layers believes, which sciences they borrow from, and how one rainstorm becomes language. No API knowledge required.
