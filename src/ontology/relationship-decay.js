...
export class RelationshipDecayManager {
     ...
     */
    decay(relationship, currentTime) {
     ...
     */
    decayBatch(relationships, currentTime) {
     ...
     */
    calculateDecay(timeSinceInteraction) {
     ...
     */
    reinforce(relationship, currentTime) {
        return {
            ...relationship,
     ...
     */
    estimateTimeUntilPruning(relationship) {
 ...
 */
export function applyDecay(relationship, timeSinceInteraction, config) {
 ...
 */
export function shouldPrune(relationship, threshold = 0.05) {
