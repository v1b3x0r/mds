...
export class IntentReasoner {
     ...
     */
    evaluateEmotionalFit(intent, emotion, reasoning) {
     ...
     */
    evaluateMemorySupport(intent, context, reasoning) {
     ...
     */
    evaluateRelationshipSupport(intent, relationships, reasoning) {
     ...
     */
    calculateRelevance(intent, context) {
 ...
 */
export function reasonAbout(intent, context) {
 ...
 */
export function chooseBestIntent(intents, context) {
    if (intents.length === 0)
        return null;
    const reasoner = new IntentReasoner();
